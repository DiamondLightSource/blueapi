...
As well as running plans through the CLI, it is possible to run plans using the docs page. In the terminal window where the worker is running, scroll to this line in the logs:
