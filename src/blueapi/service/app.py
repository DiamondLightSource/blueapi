...
from blueapi.messaging import MessageContext, MessagingTemplate, StompMessagingTemplate, AMQPMessagingTemplate
...
class Service:
    ...
    def __init__(self, config: ApplicationConfig) -> None:
        ...
        self._template = AMQPMessagingTemplate.autoconfigured(config.messaging.amqp) \
            if config.messaging.impl == 'amqp' else StompMessagingTemplate.autoconfigured(config.messaging.stomp)
