...
| worker.logging.graylog | object | `{"enabled":false,"url":"tcp://graylog-log-target.diamond.ac.uk:12231/"}` | Whether to truncate request and response bodies, which can be arbitrarily large |
